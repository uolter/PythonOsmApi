...
class OsmApi:
    ...
    def __init__(self,
        ...
        self._proxy_host = proxy_host                 # optional proxy host
        self._proxy_port = proxy_port                 # optional proxy port. Must be a numerical value
        ...
        # Http connection
        if self._proxy_host:
            self._conn = httplib.HTTPConnection(self._proxy_host, self._proxy_port)
        else:
